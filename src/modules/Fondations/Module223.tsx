        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              { label: 'Mmax', value: res.m_max.toFixed(0), unit: 'kN·m', color: 'bg-orange-50 dark:bg-orange-900/20' },
              { label: 'x éq.', value: res.x_eq.toFixed(0), unit: 'mm', color: 'bg-slate-100 dark:bg-white/5' },
            ].map((item, i) => (
