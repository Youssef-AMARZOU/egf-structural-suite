    ...
    {(() => {
      ...
      return (<>
              {(() => {
                ...
                return (
                  <g>
                    <rect x={80} y={y0} width={240} height={H} fill="#DBEAFE" stroke="#333" strokeWidth={2} />
                    ...
                    <text x={200} y={y0 - 8} fontSize={10} fill="#333" textAnchor="middle">🔥 R{inputs.r} — θg={result.theta_g.toFixed(0)}°C</text>
                  </g>
                );
              })()}
            </>);
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              { label: 'MRd,fi', value: res.m_rd_fi.toFixed(1), unit: 'kN·m/m', color: 'bg-orange-50' },
              { label: 'a500', value: res.a500.toFixed(0), unit: 'mm', color: 'bg-gray-50' },
            ].map((item, i) => (
